...
function App() {
  ...
  return (
    <div className='antialiased'>
      <div className='sm:px-20 px-4 py-2 w-full h-max bg-base-700 text-white tracking-wide font-medium flex justify-between sm:flex-row flex-col'><p> We Use Best Practices To Maintain Environment</p><p>For Reservations - 8318850612</p></div>
      <div id='BookingPage' style={{zIndex:999}} className='absolute top-0 left-0 w-full h-screen bg-black/50 hidden justify-center items-center'>
        <div className='transition-all relative w-full sm:w-3/4 h-full sm:h-3/4 bg-white rounded-sm flex justify-center items-center flex-col gap-10 px-10 sm:px-0'>
          ...
          <div className='flex justify-center items-center flex-col gap-5'>
            ...
            <p className='flex jsutify-center items-center sm:flex-col flex-col text-2xl font-s font-regular gap-4'><div className='flex'><img width="30" height="30" src="https://img.icons8.com/ios-glyphs/90/e1a140/phone--v1.png" alt="phone--v1"/>Give Us a Call</div><div className='flex sm:flex-row flex-col items-center'><p className='underline decoration-base-500 underline-offset-4 decoration-1'>+918318850612 </p><p className='no-underline'>&nbsp;, &nbsp;</p><p className='underline decoration-base-500 underline-offset-4 decoration-1'>0542-4501356</p><p className='no-underline'>&nbsp;, &nbsp;</p><p className='underline decoration-base-500 underline-offset-4 decoration-1'>9899075560</p></div> </p>
          </div>
        ...
        <div className='flex justify-center items-center flex-col gap-5'>
          <div className='font-s text-black/80'>
            ...
            <p className='text-4xl font-semibold tracking-tight text-center'>Hotel Booking Websites</p>
          </div>
          <div className='flex justify-center items-center flex-col sm:flex-row gap-10 sm:gap-6'>
            ...
            <a className='scale-75' href="https://www.agoda.com/en-gb/hotel-kashi-mantram-h62528637/hotel/varanasi-in.html?finalPriceView=1&isShowMobileAppPrice=false&cid=1917614&numberOfBedrooms=&familyMode=false&adults=2&children=0&rooms=1&maxRooms=0&checkIn=2024-11-30&isCalendarCallout=false&childAges=&numberOfGuest=0&missingChildAges=false&travellerType=1&showReviewSubmissionEntry=false&currencyCode=INR&isFreeOccSearch=false&tspTypes=-1&los=1&searchrequestid=b790fc85-2580-48c3-9618-08ef8c6c8959&ds=sJ04ll3gZJDw18l3"><img className='w-auto h-10 sm:h-20' src="/agoda.jpg" alt="" /></a>
            <a className='scale-75' href="https://expe.app.link/K2JWTh1I8Ob"><img className='w-auto h-10 sm:h-20' src="https://www.expedia.co.in/_dms/header/logo.svg?locale=en_GB&siteid=27&2&6f9ec7db" alt="" /></a>
          </div>
        </div>
        </div>
      </div>
      <div className='flex justify-between items-center sm:flex-row flex-col w-full sm:py-4 px-4 sm:px-20 py-8'>
            <h1 className='font-main2 tracking-tight text-4xl text-base-500'>Kashi Mantram</h1>
